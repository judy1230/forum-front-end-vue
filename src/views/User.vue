<template>
  <div class="container py-5">
    ...
    <div class="row">
			<div class="col-md-4">
         <UserFollowingsCard :profileFollowings="profileFollowings"/>
         <UserFollowersCard :profileFollowers="profileFollowers"/>
			</div>
      <div class="col-md-8 text-center" >
				<UserCommentsCard :profileComments="profileComments"/>
				<UserFavoritedRestaurantsCard :profileFavoritedRestaurants="profileFavoritedRestaurants"/>
			</div>
    </div>
  </div>
</template>
	...
	methods: {
		fetchProfile(profileId) {
          ...
          image: dummyData.profile.image
				...
				this.profileComments = dummyData.profile.Comments
				this.profileFollowings = dummyData.profile.Followings
				this.profileFollowers = dummyData.profile.Followers
				this.profileFavoritedRestaurants = dummyData.profile.FavoritedRestaurants
				console.log('this.profileComments',this.profileComments)
			}
	},
