    ...
    <tbody>
      <tr v-for="restaurant in restaurants" :key="restaurant.id">
        ...
        <td class="d-flex justify-content-between">
          ...
          <router-link :to="{name: 'admin-restaurant-edit', params: {id: restaurant.id}}">Edit</router-link>
          <button @click.stop.prevent="deleteRestaurant(restaurant.id)" type="button" class="btn btn-link">Delete</button>
        </td>
      </tr>
    </tbody>
  </table>
  ...
  restaurants: [
    {
      ...
      updatedAt: "2020-04-05T14:31:35.000Z",
      CategoryId: 4,
      Category: {
        id: 4,
        name: "墨西哥料理",
    ...
    },
    {
      ...
      viewCounts: 15,
      createdAt: "2020-02-28T14:38:32.000Z",
      updatedAt: "2020-04-03T15:12:23.000Z",
      CategoryId: 3,
      Category: {
        id: 3,
        name: "義大利料理",
    ...
    },
    {
      ...
      viewCounts: 15,
      createdAt: "2020-02-28T14:38:32.000Z",
      updatedAt: "2020-04-03T15:12:30.000Z",
      CategoryId: 5,
      Category: {
        id: 5,
        name: "素食料理",
    ...
    },
    {
      ...
      viewCounts: 3,
      createdAt: "2020-02-28T14:38:32.000Z",
      updatedAt: "2020-04-03T15:12:33.000Z",
      CategoryId: 1,
      Category: {
        id: 1,
        name: "中式料理",
    ...
    },
    {
      ...
      viewCounts: 5,
      createdAt: "2020-02-28T14:38:32.000Z",
      updatedAt: "2020-04-03T15:12:36.000Z",
      CategoryId: 2,
      Category: {
        id: 2,
        name: "日本料理",
    ...
    {
      id: 15,
      name: "Richmond Corkery",
      tel: "698.382.3761",
      address: "23899 Rosenbaum Causeway",
      opening_hours: "08:00",
      description: "esse blanditiis libero",
      image:
        "https://loremflickr.com/320/240/restaurant,food/?random=84.02951589176762",
      viewCounts: 5,
      createdAt: "2020-02-28T14:38:32.000Z",
      updatedAt: "2020-03-27T10:36:40.000Z",
      CategoryId: 1,
      Category: {
        id: 1,
        name: "中式料理",
    ...
    },
    {
      ...
      image: null,
      viewCounts: 1,
      createdAt: "2020-04-03T09:05:08.000Z",
      updatedAt: "2020-04-03T16:21:31.000Z",
      CategoryId: 1,
      Category: {
        id: 1,
        name: "中式料理",
    ...
    },
    {
      ...
      image: null,
      viewCounts: 0,
      createdAt: "2020-04-05T10:51:59.000Z",
      updatedAt: "2020-04-05T10:51:59.000Z",
      CategoryId: 1,
      Category: {
        id: 1,
        name: "中式料理",
    ...
    },
    {
      ...
      image: null,
      viewCounts: 0,
      createdAt: "2020-04-05T10:56:27.000Z",
      updatedAt: "2020-04-05T10:56:27.000Z",
      CategoryId: 3,
      Category: {
        id: 3,
        name: "義大利料理",
    ...
    },
    {
      ...
      image: "https://i.imgur.com/aTYxUUU.jpg",
      viewCounts: 0,
      createdAt: "2020-04-05T10:56:58.000Z",
      updatedAt: "2020-04-05T10:56:58.000Z",
      CategoryId: 6,
      Category: {
        id: 6,
        name: "美式料理",
    ...
    },
    {
      ...
      image: null,
      viewCounts: 0,
      createdAt: "2020-04-05T10:57:43.000Z",
      updatedAt: "2020-04-05T10:57:43.000Z",
      CategoryId: 3,
      Category: {
        id: 3,
        name: "義大利料理",
    ...
    },
    {
      ...
      image: null,
      viewCounts: 0,
      createdAt: "2020-04-05T10:58:46.000Z",
      updatedAt: "2020-04-05T10:58:46.000Z",
      CategoryId: 3,
      Category: {
        id: 3,
        name: "義大利料理",
    ...
    },
    {
      ...
      image: null,
      viewCounts: 0,
      createdAt: "2020-04-05T10:59:33.000Z",
      updatedAt: "2020-04-05T10:59:33.000Z",
      CategoryId: 4,
      Category: {
        id: 4,
        name: "墨西哥料理",
    ...
    },
    {
      ...
      image: null,
      viewCounts: 0,
      createdAt: "2020-04-05T10:59:56.000Z",
      updatedAt: "2020-04-05T10:59:56.000Z",
      CategoryId: 2,
      Category: {
        id: 2,
        name: "日本料理",
    ...
    },
    {
      ...
      image: null,
      viewCounts: 0,
      createdAt: "2020-04-05T11:00:55.000Z",
      updatedAt: "2020-04-05T11:00:55.000Z",
      CategoryId: 6,
      Category: {
        id: 6,
        name: "美式料理",
    ...
    },
    {
      ...
      opening_hours: "11:01",
      description: "10110",
      image: "https://i.imgur.com/vFeOOaa.jpg",
      viewCounts: 0,
      createdAt: "2020-04-05T11:01:26.000Z",
      updatedAt: "2020-04-05T11:01:26.000Z",
      CategoryId: 4,
      Category: {
        id: 4,
        name: "墨西哥料理",
    ...
    },
    {
      ...
      opening_hours: "00:00",
      description: "000",
      image: "https://i.imgur.com/Sq3fpvC.jpg",
      viewCounts: 0,
      createdAt: "2020-04-05T11:02:54.000Z",
      updatedAt: "2020-04-05T11:02:54.000Z",
      CategoryId: 4,
      Category: {
        id: 4,
        name: "墨西哥料理",
    ...
    {
      id: 1642,
      name: "55555555555556666666666",
      tel: "55",
      address: "5656",
      opening_hours: "05:06",
      description: "5655",
      image: "https://i.imgur.com/6XQCY45.jpg",
      viewCounts: 0,
      createdAt: "2020-04-05T11:06:35.000Z",
      updatedAt: "2020-04-05T11:06:35.000Z",
      CategoryId: 4,
      Category: {
        id: 4,
        name: "墨西哥料理",
